...
public class BenchMarkCompareAlg {

	public static void main(String[] args) {
		Util.rnd.setSeed(42); // set the seed of the
		//Util.rnd.setSeed(System.currentTimeMillis()); // set the seed of the
		// random generator
		...
		for (Algorithm al : players) {
			ra.addPlayer(al, al.getID(), 1500, 350, 0.06, 0, 0, 0); // init
																	// rating
																	// 1500
		}
		BankOfResults ba = new BankOfResults();

		rpuoed2.run(ra, ba, 15);
